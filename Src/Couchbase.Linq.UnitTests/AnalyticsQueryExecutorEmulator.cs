...
namespace Couchbase.Linq.UnitTests
{
    ...
    /// </summary>
    internal class AnalyticsQueryExecutorEmulator : IAnalyticsQueryExecutor
    {
        private readonly ClusterVersion _clusterVersion;

        public AnalyticsTestBase Test { get; }
        public string Query { get; private set; }

        public AnalyticsQueryExecutorEmulator(AnalyticsTestBase test, ClusterVersion clusterVersion)
        {
        ...
        public Task<IEnumerable<T>> ExecuteCollectionAsync<T>(AnalyticsRequest queryResult, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        public Task<T> ExecuteSingleAsync<T>(AnalyticsRequest queryRequest, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
    }
